...
def mehendi():
    ...
    headingLabel = Label(headingFrame1, text="Manage Mehendi Event", bg='black', fg='white', font=('Courier',15))
    ...
    # rituals_button = Button(root,text="Login",bg='black', fg='white', command=rituals)
    # rituals_button.pack()

    # cocktail_button = Button(root,text="Login",bg='black', fg='white', command=cocktail)
    # cocktail_button.pack()
